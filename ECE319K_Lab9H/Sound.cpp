...
const uint8_t* pointer_to_sound[6] = {shoot+4080, explosion+8731, ufo_highpitch_menu+1802, metal_crunch+3525, no_ammo+1716, no_ammo_2+3308}; // array of sound wave pointers pointing to last element+1
